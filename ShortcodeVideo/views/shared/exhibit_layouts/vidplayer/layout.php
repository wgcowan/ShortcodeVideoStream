			...
			<?php if ($current) { ?>
				...
				<div class="displaySegmentRightColumn">
					...
					<ul id="eventList" style="-webkit-padding-start:10px;">	    
								<li id="<?php echo metadata('item', array('Dublin Core', 'Identifier'));?>" class="liBullet <?php echo metadata('item',array('Streaming Video','Segment Type'));?>">
									<span class="bullet"></span>
									<div class="event<?php echo $eid_suffix;?>" stime="<?php echo metadata('item',array('Streaming Video','Segment Start'));?>" etime="<?php echo metadata('item',array('Streaming Video','Segment End'));?>">
										<div class="eventLabel"><?php echo metadata('item',array('Streaming Video','Segment Type'));?> <span class="timecode"><?php echo $this->getFormattedTimeString(metadata('item',array('Streaming Video','Segment Start')));?> - <?php echo $this->getFormattedTimeString(metadata('item',array('Streaming Video','Segment End')));?></span>
										</div>
								...
								<a id="doplay<?php echo $eid_suffix;?>" title="Play Video Segment"stime="<?php echo metadata('item',array('Streaming Video','Segment Start'));?>" etime="<?php echo metadata('item',array('Streaming Video','Segment End'));?>" href='#'> Play Segment</a>
								...
								<div class="play<?php echo $eid_suffix;?>" title="Play Video Segment"stime="<?php echo metadata('item',array('Streaming Video','Segment Start'));?>" etime="<?php echo metadata('item',array('Streaming Video','Segment End'));?>"style="color:darkblue; display:none"><strong>Playing Segment </strong></font></div>
								</div>
								</li>
...
foreach($attachments as $vattItem):
	...
	if ((calculateTime("<?php echo metadata('item', array('Streaming Video','Segment End'));?>")) > (finalendTime<?php echo $eid_suffix;?>)){
		finalendTime<?php echo $eid_suffix;?> = calculateTime("<?php echo metadata('item', array('Streaming Video','Segment End'));?>") ;
	};
	<?php $a++; ?>	
<?php endforeach;?>
